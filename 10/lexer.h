...
//    new CharLexemeMatcher(Token::GT, '>'),
    ...
    new CharLexemeMatcher(Token::LEFT_SQR_BRACKET, '['),
    new CharLexemeMatcher(Token::RIGHT_SQR_BRACKET, ']'),
    new SpecificIdLexemeMatcher(Token::LET, "let"),
    new SpecificIdLexemeMatcher(Token::DEF, "def"),
    new SpecificIdLexemeMatcher(Token::RE, "Re"),
    new SpecificIdLexemeMatcher(Token::IM, "Im"),
    new IdLexemeMatcher(),
